...
\begin{itemize}[leftmargin=*]
  \item[]
  \ressubheading{Apple, Inc. - \small{Siri Rotational Program}}{Cupertino, CA}{Software Engineer}{January 2019 -- present}
  \item[]
  ...
  {\footnotesize
    \begin{itemize}
      ...
      \resitem{Enhanced frontend user management pages in React and Redux to leverage backend improvements}
      \resitem{Developed and deployed user-invite flow improvements across several codebases and microservices}
  \end{itemize}}
	\item[]
...
\resheading{Education}
	\begin{itemize}[leftmargin=*]
		\item[]
			\ressubheading{\href{http://www.northeastern.edu}{Northeastern University} - College of Computer and Information Science}{Boston, MA}{{Bachelor of Science in Computer Science - }{GPA: 3.80/4.00}}{December 2018}
				{ \footnotesize
				\begin{itemize}
