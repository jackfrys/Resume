...
\begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
	\textbf{\LARGE Jack Frysinger} & \\\textbf{Available:} January 2019 & \\\textbf{GitHub:} \href{https://github.com/jackfrys}{github.com/jackfrys} & #1--#2--#3 \\\textbf{LinkedIn:} \href{http://linkedin.com/in/jackfrys}{linkedin.com/in/jackfrys} & \href{mailto:#4@#5}{#4{@}#5}
	\end{tabular*}
	\\\vspace{0.1in}}
