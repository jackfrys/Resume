...
\begin{description}
	...
	\item[] \hspace{0.03in} \textbf{Software:} {\footnotesize OS X, Windows, Git/GitHub, Gradle, Bash, IntelliJ IDEA, \LaTeX}
	\item[] \hspace{0.03in} \textbf{Hot + Cold:} {\footnotesize Navigates user to a random destination in the area using warmer and colder directives. Initially developed at HackBeanpot in February 2015; updated in November 2016. Available on the iOS App Store.}
	\item[] \hspace{0.03in} \textbf{Disputation Helper:} {\footnotesize Helps user construct and deliver a clear and sound rhetorical argument during a Disputation, a form of academic debate. iOS app proof of concept completed in January 2017.}
