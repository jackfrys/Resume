...
\begin{description}
	...
	\item[] \hspace{0.03in} \textbf{Software:} {\footnotesize macOS, Git/GitHub, IntelliJ IDEA, Gradle, WebStorm, \LaTeX, Windows, Linux, Bash}
	...
	\item[] \hspace{0.03in} \textbf{Disputor:} {\footnotesize Helps user construct and deliver a clear and sound rhetorical argument during a Disputation, a form of academic debate. iOS app proof of concept completed January 2017.}
\end{description}}
